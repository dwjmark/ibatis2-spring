 ...
 * @since v1.0
 */
public class BatchDeleteHandle implements Opcodes, MethodGenerator{

	/**
	 * sqlMapClientTemplate方法：insert
	 */
	private static final String SQLMAPCLIENT_METHOD_INSERT = "batchDelete";
	...
	public boolean validate(Method method) {
		if(!Pattern.matches("(batchDelete|batchRemove|batchDel)[\\S]*", method.getName())){
			return false;
