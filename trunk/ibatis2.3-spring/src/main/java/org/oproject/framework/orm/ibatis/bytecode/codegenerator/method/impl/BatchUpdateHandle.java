 ...
 * @since v1.0
 */
public class BatchUpdateHandle implements Opcodes, MethodGenerator{

	/**
	 * sqlMapClientTemplate方法：insert
	 */
	private static final String SQLMAPCLIENT_METHOD_INSERT = "batchUpdate";
	...
	public boolean validate(Method method) {
		if(!Pattern.matches("(batchUpdate)[\\S]*", method.getName())){
			return false;
