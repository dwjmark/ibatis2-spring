...
public class SqlMapClientFactoryBean  implements FactoryBean<SqlMapClient>,
    ...
    protected SqlMapClient buildSqlMapClient(Resource[] configLocations,
        ...
        if (mappingLocations != null) {
            ...
            //对mappingLocations做排序，防止在某些系统上面加载文件的顺序不是按a-z
            Arrays.sort(mappingLocations,new Comparator(){

				@Override
				public int compare(Object arg0, Object arg1) {
					Resource p1 = (Resource) arg0;
					Resource p2 = (Resource) arg1;
					
					int char1 = p1.getFilename().charAt(0);
					int char2 = p2.getFilename().charAt(0);
					if(char1>char2)
					{
						return 1;
					}else if(char1<char2)
